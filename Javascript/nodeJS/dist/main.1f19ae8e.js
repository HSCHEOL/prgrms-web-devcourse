...
function fetchMovies() {
  _axios.default.get("https://www.omdbapi.com/?apikey=7035c60c&s=".concat(input.value)) //api 받아오고
  .then(function (response) {
    ...
    response.data.Search.map(function (obj) {
      h1El.innerHTML = "<div>".concat(obj.Title, "</div>");
...
},{"./Data.json":"Data.json","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
